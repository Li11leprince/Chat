...
extension Colors {
    ...
    public var labelSecondaryVariant2: UIColor { valueOrStub("label_secondary_variant2") }
    ...
    public var fillSecodaryVariant: UIColor { valueOrStub("fill_secondary_variant") }
}
